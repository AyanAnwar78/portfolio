...
export default function Education({ theme }) {
  ...
  return (
    <section className="py-24 px-6 md:px-12 lg:px-24" id="education" ref={sectionRef}>
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-8 lg:gap-24">
        ...
        <div className="md:w-2/3 flex flex-col gap-16">
          {education.map((item, idx) => (
            <div key={idx} ref={(el) => (itemsRef.current[idx] = el)} className="flex flex-col gap-4 border-l border-black/10 dark:border-white/10 pl-8 md:pl-12 relative">
              {/* Timeline dot */}
